                ...
                <div class="d-flex flex-lg-row flex-column">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                          ...
                          <a class="dropdown-item" href="special-dishes.html">Sauce légume</a>
                        </div>
                    </li>
                </div>
            </ul>
...
<p> Votre votre email était  :<?php echo $_POST['email']; ?> !</p>
<p> Votre Numero était:  <?php echo $_POST['phoneNumber']; ?> !</p>
<p> Votre date de reservation est le :<?php echo $_POST['date']; ?> !</p>
<p> Votre heure de reservation est  à :<?php echo $_POST['time']; ?> !</p>
<p> Votre nombre de Reservation est :<?php echo $_POST['nombre']; ?> !</p>
<p> Votre message était :<?php echo $_POST['message']; ?> !</p>
         ...
         <div class="row">
            <div class="col-lg-4">
                <div class="footer-widget pr-lg-5 pr-0">
                    ...
                    <p>ENASTIC-Resto est toujour ouvert à votre service,les plats magnifiques ,cuisinés par des experts ,chevronnés du domaine.Vous pouvez également passer votre commande depuis votre votre maison et la livraison sera rapide et grauite.</p>
            ...
            <div class="col-md-12 d-flex align-items-center">
                <p class="mx-auto text-center mb-0">Copyright 2021. Tout Droit Reservé. Developpé par <a href="https://groupe2.td" target="_blank">Groupe2_ENASTIC_DTS2</a></p>
            </div>
